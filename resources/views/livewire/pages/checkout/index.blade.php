<div class="bg-brand-neutral min-h-screen py-12 md:py-20">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Header -->
        <div class="mb-12">
            <h1 class="text-4xl md:text-5xl font-black text-gray-900 font-heading uppercase tracking-tighter mb-2">{{ __('Checkout') }}</h1>
            <p class="text-gray-500 font-medium italic">{{ __('Review your selection and complete your order.') }}</p>
        </div>
        ...
        <div class="flex flex-col lg:flex-row gap-12 items-start">
            ...
            <div class="lg:w-2/3 w-full">
                <div class="flex items-center justify-between mb-8">
                    <h2 class="text-2xl font-black text-gray-900 font-heading uppercase tracking-tighter">{{ __('Your Selection') }}</h2>
                    <span class="bg-secondary text-gray-900 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest">{{ $items->count() }} {{ __('Items') }}</span>
                </div>
                            ...
                            <div class="flex flex-col sm:flex-row gap-6 items-center">
                                ...
                                <div class="flex-1 text-center sm:text-left">
                                    ...
                                    <p class="text-sm text-gray-400 font-medium mb-4 line-clamp-1">
                                        ...
                                        {{ $item['observations'] ?? __('No special observations') }}
                                    </p>
                ...
                <div class="mt-12">
                    <h4 class="text-[10px] font-black text-gray-400 uppercase tracking-[0.3em] mb-4">{{ __('Special Instructions') }}</h4>
                    <textarea 
                        wire:model="notes"
                        placeholder="{{ __('E.g. Extra crispy crust, light on cheese...') }}"
            ...
            <div class="lg:w-1/3 w-full sticky top-32">
                <div class="bg-white/80 backdrop-blur-xl rounded-[40px] p-10 border border-white shadow-2xl shadow-gray-200/40">
                    <h2 class="text-2xl font-black text-gray-900 font-heading uppercase tracking-tighter mb-8 pb-8 border-b border-gray-100">{{ __('Order Summary') }}</h2>

                    <div class="space-y-4 mb-10">
                        <div class="flex justify-between items-center text-sm font-medium">
                            <span class="text-gray-400 uppercase tracking-widest">{{ __('Subtotal') }}</span>
                            <span class="text-gray-900 font-black italic">{{ number_format($total, 2) }}€</span>
                        </div>
                        <div class="flex justify-between items-center text-sm font-medium">
                            <span class="text-gray-400 uppercase tracking-widest">{{ __('Delivery Fee') }}</span>
                            <span class="text-tertiary font-black italic">{{ __('FREE') }}</span>
                        </div>
                        <div class="flex justify-between items-center pt-6 border-t border-gray-50">
                            <span class="text-gray-900 font-black text-xl uppercase tracking-tighter font-heading">{{ __('Total') }}</span>
                    ...
                    <div class="mb-6 p-6 rounded-3xl bg-brand-neutral/50 border border-gray-50 group hover:border-primary/20 transition-all">
                        <div class="flex justify-between items-center mb-4">
                            <h4 class="text-[10px] font-black text-gray-400 uppercase tracking-widest">{{ __('Delivery Address') }}</h4>
                        </div>
                    ...
                    <div class="mb-10 p-6 rounded-3xl bg-brand-neutral/50 border border-gray-100 group transition-all opacity-50">
                        <div class="flex justify-between items-center mb-4">
                            <h4 class="text-[10px] font-black text-gray-400 uppercase tracking-widest">{{ __('Payment Method') }}</h4>
                        </div>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <p class="text-xs font-black text-gray-900">{{ __('Payment on Delivery') }}</p>
                            </div>
                    ...
                    >
                        ...
                        <span wire:loading.flex wire:target="placeOrder" class="flex items-center gap-3">
